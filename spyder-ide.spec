...
%prep
%setup -q -n spyder-4.2.1
cd %{_builddir}/spyder-4.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609282742
...
cp %{_builddir}/spyder-4.2.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/spyder-ide/22c12f6b37fae71737eba4178d938fa6a4014003
cp %{_builddir}/spyder-4.2.1/external-deps/python-language-server/LICENSE %{buildroot}/usr/share/package-licenses/spyder-ide/4df3c87108ebab83aa7bb222e245d841c6574d4f
cp %{_builddir}/spyder-4.2.1/external-deps/python-language-server/vscode-client/License.txt %{buildroot}/usr/share/package-licenses/spyder-ide/ad6ef38a8f164b92c812d5e823c5873b38a28f8e
cp %{_builddir}/spyder-4.2.1/external-deps/spyder-kernels/LICENSE.txt %{buildroot}/usr/share/package-licenses/spyder-ide/4d8c327cf6d4ba1ac22d4feb6df04672893016ef
cp %{_builddir}/spyder-4.2.1/img_src/oxygen_icon_set/LICENSE.txt %{buildroot}/usr/share/package-licenses/spyder-ide/8f8bc9efa4291244a381947813e32326ef3c301d
cp %{_builddir}/spyder-4.2.1/installers/Windows/assets/black/black-20.8b1.dist-info/LICENSE %{buildroot}/usr/share/package-licenses/spyder-ide/edd079e7a759fe1fcf1d089e28b9c7df2080b42c
cp %{_builddir}/spyder-4.2.1/spyder/plugins/help/utils/js/mathjax/LICENSE.txt %{buildroot}/usr/share/package-licenses/spyder-ide/c646d2cd1433560a4b43cb98e7273b59aac4563c
cp %{_builddir}/spyder-4.2.1/spyder/utils/external/binaryornot/LICENSE.txt %{buildroot}/usr/share/package-licenses/spyder-ide/3a9052b4cf583cf56f81ceec5e688aa475b97032
cp %{_builddir}/spyder-4.2.1/spyder/widgets/github/LICENSE.txt %{buildroot}/usr/share/package-licenses/spyder-ide/7fe07a375ab07059ff21c6b8a36ccb37811bd67c
...
/usr/share/package-licenses/spyder-ide/edd079e7a759fe1fcf1d089e28b9c7df2080b42c
